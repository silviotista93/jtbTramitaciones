...
@section('header')
    @if(!isset($infoTramitador->idtramitador->id))
        <h3>No exiten tramites asociados</h3>
    @else
        <h1>
            <strong>Todos los tramites de:</strong>
        </h1>
    <h3>{{$infoTramitador->idtramitador->name}} {{$infoTramitador->idtramitador->apellidos}}</h3>
    @endif
    <ol class="breadcrumb">
...
@section('contenido')
    ...
    <div class="box box-primary">
        ...
        <div class="box-header">
            ...
            <button type="button" class="btn btn-default pull-right" id="dpFechaTramitador">
                <span>
    ...
    <script>
        ...
        function cargarTabla (){
            ...
            table = $('.table_admiVentas').DataTable({
                ...
                "data": null,
                "ajax": {
                    url: "{{route('tablaTramitesTramitadores',$infoTramitador->idtramitador->id)}}",
                    data: {
