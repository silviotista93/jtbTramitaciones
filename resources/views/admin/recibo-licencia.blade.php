            ...
            <div id="table">
                <table class="table-main" style="margin-left: 10px">
                    ...
                    @foreach($obtenerDatos->licenciaTramite as $obtenerDato)
                        <tr class="list-item">
                            <td data-label="Type" class="tableitem">{{$obtenerDatos->cantidadLicencia($obtenerDato->id)[0]->cantidad}}</td>
                            <td data-label="Quantity" class="tableitem">{{$obtenerDato->tipo_licencia}}</td>
