        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #056F00;">
                    ...
                    <form class="FormActualizarContacto" id="form-actualizar-contacto" method="post" action="">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                            <button type="submit" id="btn_actualizar_contacto" style="display:none" class="btn btn-info" data-dismiss="modal">Actualizar</button>
            ...
            $('#table_agenda').DataTable({
                ...
                {data: 'telefono',defaultContent:'<span class="label label-danger text-center">Ningún valor por defecto</span>'},
                {
                    render:function (data,type, JsonResultRow,meta) {
                        ...
                        '<button class="btn btn-sm btn-info btnEditContacto" idContacto="'+JsonResultRow.id+'" data-toggle="modal" data-target="#modalInfoAgendaContacto"><i class="fa fa-pencil"></i></button>'
