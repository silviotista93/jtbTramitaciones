...
<div class="wrapper">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    ...
                                    <small>Desde {{auth()->user()->created_at->toFormattedDateString()}}</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            {{--<li class="user-body">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{route('editarPerfil')}}" class="btn btn-default btn-flat">Perfil</a>
                                </div>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2018 <a href="#">TJB Tramitaciones</a>.</strong> All rights reserved.
    </footer>

    @include('admin.partials.barra-lateral')
</div>
<!-- ./wrapper -->
