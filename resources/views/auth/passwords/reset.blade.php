...
<head>
    ...
    <title>Tramitaciones | Reestablecer Contraseña</title>
    ...
    <div class="register-box-body">
        ...
        <form method="POST"  action="{{ route('password.request') }}" aria-label="{{ __('Reset Password') }}">
            ...
            <div class="row">
                <!-- /.col -->
                <div class="col-xs-12">
                    <button type="submit" class="btn btn-primary btn-block btn-flat">Reestablcer Contraseña</button>
                </div>
                <!-- /.col -->
            </div>
        </form>
        ...
        <div class="text-center">
            <a href="/" class="text-center">Volver al login</a>
        </div>
