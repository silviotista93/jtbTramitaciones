        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <span class="label label-info text-center pull-right" style="font-size: 16px;"> Descuento actual ${{$valor_medico->valor}}</span>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="{{route('examen-medico-actualizado',$valor_medico->id)}}">
                    ...
                    <div class="box-body">
                        ...
                        <span class="help-block">Fecha de ultima actualizacion {{$valor_medico->updated_at->format('l jS \\of F Y h:i:s A')}}</span>
